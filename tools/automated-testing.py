...
parser.add_argument("-l", "--log_level", required=False, type=int, default=logging.INFO, nargs=1,
...
log_level: int = args.log_level[0]
if threads < 1:
    threads = 1
...
def worker(job: tuple[str, str]) -> tuple[bool, str]:
    ...
    """
    # close logger prevents resource leaks
